...
const ACTION_OPTIONS = [
  ...
  { value: "user.exemption_update", label: "user.exemption_update" },
  { value: "user.access_update", label: "user.access_update" },
  { value: "team.create", label: "team.create" },
  { value: "team.update", label: "team.update" },
  { value: "team.delete", label: "team.delete" },
  { value: "team.member_add", label: "team.member_add" },
  { value: "team.member_remove", label: "team.member_remove" },
